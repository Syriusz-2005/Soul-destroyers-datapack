scoreboard players remove @s ma.fungus_throw.lifetime 1


execute if score @s ma.fungus_throw.lifetime matches ..0 run kill @s
...
execute if entity @p[distance=..2] run function mob-abilities:guard_forest/fungus_hit_player
