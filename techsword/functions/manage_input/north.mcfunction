...
execute as @a[tag=techsword] at @s unless entity @e[type=interaction,tag=techsword.input.1,distance=..3] anchored eyes positioned ^ ^ ^ run summon interaction ~ ~-0.5 ~-1 {Tags:["techsword.input.1"],width:1,height:1}
