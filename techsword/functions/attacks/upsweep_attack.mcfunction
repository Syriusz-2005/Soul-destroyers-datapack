...
execute rotated ~ 0 positioned ^ ^ ^2 rotated ~ -80 as @e[distance=..1.5] run function knockback:api/knockback_facing
execute rotated ~ 0 positioned ^ ^ ^2 as @e[distance=..1.9] run damage @s 2 player_attack
