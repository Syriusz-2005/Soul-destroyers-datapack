...
execute if entity @s[tag=!techsword.effects.parried] run attribute @s generic.attack_damage modifier add deadbabe-2137-4387-bf37-b8b68f333f71 "parried" -0.6 multiply
