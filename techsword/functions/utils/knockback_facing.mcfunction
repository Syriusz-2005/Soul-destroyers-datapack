...
scoreboard players operation #targetX knockback.pos *= $strength techsword.knockback_facing
scoreboard players operation #targetY knockback.pos *= $strength techsword.knockback_facing
scoreboard players operation #targetZ knockback.pos *= $strength techsword.knockback_facing
